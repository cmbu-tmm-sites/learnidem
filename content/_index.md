...
{{% w3-button-icon icon="fab fa-google" href="https://github.com/cmbu-tmm-sites/learnidem/blob/main/content/Getting%20Started/_index.md" %}}Get Started{{% /w3-button-icon %}}
